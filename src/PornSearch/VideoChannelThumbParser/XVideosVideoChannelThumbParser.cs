...
{
    internal class XVideosVideoChannelThumbParser : IPornVideoThumbParser
    {
        private readonly XVideosJsonSearchChannelVideos _root;

        public XVideosVideoChannelThumbParser(XVideosJsonSearchChannelVideos root) {
            _root = root;
        }
